...
function btnEntrenar_Callback(hObject, eventdata, h)
    value =[]
    value(1) = get(h.E1,'Value')
    value(2) = get(h.E2,'Value')
    value(3) = get(h.E3,'Value')
    value(4) = get(h.E4,'Value')
    value(5) = get(h.E5,'Value')
    value(6) = get(h.E6,'Value')
    value(7) = get(h.E7,'Value')
    value(8) = get(h.E8,'Value')
    value(9) = get(h.E9,'Value')
    value(10) = get(h.E10,'Value')
    value(11) = get(h.E11,'Value')
    value(12) = get(h.E12,'Value')
    value(13) = get(h.E13,'Value')
    value(14) = get(h.E14,'Value')
    value(15) = get(h.E15,'Value')
    value(16) = get(h.E16,'Value')
    value(17) = get(h.E17,'Value')
    value(18) = get(h.E18,'Value')
    value(19) = get(h.E19,'Value')
    value(20) = get(h.E20,'Value')
    value(21) = get(h.E21,'Value')
    value(22) = get(h.E22,'Value')
    value(23) = get(h.E23,'Value')
    value(24) = get(h.E24,'Value')
    value(25) = get(h.E25,'Value')
